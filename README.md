...
- ```main``` - Актуальная версия приложения, выложенная в сторы.
- ```develop``` - Актуальная версия, находящаяся в разработке.
- ```feature/...``` - Ветки разработчиков, готовящиеся к слиянию с основной.
- ```tmp/...``` - Временные ветки.
